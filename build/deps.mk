...
SOURCE+= scene_maingame.cpp board.cpp block.cpp marker.cpp keymap.cpp movebehaviour.cpp
...
DEPS+= scene_maingame.h board.h block.h animation.h marker.h interpolatedvalue.h interpolatedvalue.hpp event.h keymap.h mover.h mover.hpp movebehaviour.h
